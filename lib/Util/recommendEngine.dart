...
Future<List<Map<String,dynamic>>> SearchEngine({required String query, }) async {
  ...
  try {
    ...
    if (searchParts.length > 1) {
      result =
      await result.where("name.lname", isEqualTo: searchParts[1] as String);
    }
    ...
    print("Error with Search Engine - ${e}");
  }
//print(Lawyers);
  return Lawyers;
}